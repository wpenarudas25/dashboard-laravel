...
<div>
    <div class="alert alert-secondary mx-4" role="alert">
        <span class="text-white">
            ...
            <a href="#" target="_blank" class="text-white">here</a></strong>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Wilmar Peña</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">wpenarudas@gmail.com</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Admin</p>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-secondary text-xs font-weight-bold">11/02/25</span>
                                    </td>
                                    <td class="text-center">
